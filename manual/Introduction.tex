...
Unlike ``down'' messages~\see{monitoring}, the default behavior for received exit messages causes the receiving actor to terminate as well when receiving a non-normal exit reason.
